...
public class Assignment {
    ...
    public static void main(String[] args)  {
        ...
        listNamesOfDirectories("src/Week_1.Week1_day3/test_directory");

        System.out.println("2)");
        appendToFile("src/Week_1.Week1_day3/test_directory/file1","abacadae");

        System.out.println("3)");
        System.out.println(countCharOccurrence("src/Week_1.Week1_day3/test_directory/file1",args[0].charAt(0)));
